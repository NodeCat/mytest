...
class SkuInfoLogic 
{
    ...
    public function calculatePrice($skuCodeArr = array(), $warehouseId = 0, $stime = 0, $etime = 0) 
    {
        ...
        $map['stock_purchase.expecting_date']    = array('elt', date('Y-m-d H:i:s', $etime));
        if ($warehouseId > 0) {
        ...
        $map['erp_process_in.created_time']      = array('elt', date('Y-m-d H:i:s', $etime));
        if ($warehouseId > 0) {
    ...
    public function stockSellQty($skuCodeArr = array(), $warehouseId = 0, $stime = 0, $etime = 0)
    {
        ...
        $map['stock_bill_out.op_date'] = array('elt', date('Y-m-d H:i:s', $etime));

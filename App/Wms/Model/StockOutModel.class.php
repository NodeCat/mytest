...
class StockOutModel extends Model {
    ...
    protected $insertFields = array('id','code','wh_id','type','refer_code','notes','op_date','status','gennerate_method','line_id','process_type','wave_id','refused_type','company_id','created_user','created_time','updated_user','updated_time','is_deleted');
    protected $updateFields = array('code','wh_id','type','refer_code','notes','op_date','status','gennerate_method','line_id','process_type','wave_id','refused_type','company_id','created_user','created_time','updated_user','updated_time','is_deleted');

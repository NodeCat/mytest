...
"field"=>"stock_purchase.*,stock_purchase.invoice_method as invoice_method_code,stock_purchase.status as state,sbi.code as in_code,sbi.id as in_id,warehouse.code as warehouse_code,warehouse.name as warehouse_name,partner.name as partner_name,user.nickname as user_nickname,user.mobile as user_mobile,company.name as company_name",
        ),
        'latest'=>array(
            'where'=>array('stock_purchase.is_deleted'=>'0'),

...
class SettlementController extends CommonController
{
    ...
    protected function before_edit($data)
    {
        ...
        $field  =  'erp_settlement_detail.*, stock_purchase.id as pid, erp_purchase_refund.id as refund_id';
    ...
    public function add()
    {
        if (IS_AJAX && IS_POST) {
            ...
            $result = $logic->saveData($partner_id, $total_amount, $bill_number, $bill_amount, $sn, $paid, $stock, $refund);
    ...
    public function getOrderList()
    {
        ...
        if (IS_AJAX) {
            ...
            if (!empty($code_type)) {
                ...
                $returnArray = array_merge($result, $result1, $result2);
            }
    ...
    public function pay()
    {
        ...
        M('erp_settlement')->where($map)->data($data)->save();
        unset($data);
